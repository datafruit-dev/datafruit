---
title: Ghostship API
description: API reference for deploying and managing Kubernetes apps using Ghostship.
---

# Ghostship API

Ghostship allows you to deploy, manage, and monitor applications directly from GitHub into your Kubernetes cluster. Each request must be authenticated using an API key and project ID.
